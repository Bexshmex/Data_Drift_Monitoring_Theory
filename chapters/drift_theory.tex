...
\subsection{Data Drift, Concept Drift, and Prediction Drift}
...
These types of drift are related but not identical. Data drift can happen before performance degradation becomes visible. Concept drift can directly reduce model quality. Prediction drift can work as an early warning signal when labels are delayed or unavailable.
